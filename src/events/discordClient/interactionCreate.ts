...
/**
 * Formats the command option from an interaction into a string.

 * @param {CommandInteractionOption} option - The option of a command interaction.
 * @returns {string} A formatted string of command option.
 */
function formatOption(option: CommandInteractionOption): string {
